...
const EmployeeForm = ({ onSave, disabled, employee, onCancel, equipments, favBrands, startDate, favColor, desSalary, currSalary, boardGame, favTool, session, address }) => {
  ...
  return (
    <form className="EmployeeForm" onSubmit={onSubmit}>
      ...
      <div className="control">
        <label htmlFor="tools">Favorite Tool:</label>
        {favTool}
      </div>
